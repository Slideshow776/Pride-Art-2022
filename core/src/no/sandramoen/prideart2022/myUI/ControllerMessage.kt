...
class ControllerMessage : Table() {
    ...
    fun showConnected() {
        ...
        setLabel("Controller Connected", Color(0.659f, 0.792f, 0.345f, 1f)) // green
        fadeInAndOut()
    }

    fun showDisConnected() {
        changeImageTo("controllerDisconnected")
        setLabel("Controller Disconnected", Color(0.812f, 0.341f, 0.235f, 1f)) // red
        fadeIn()
    }

    fun showNoControllerFound() {
        changeImageTo("controllerDisconnected")
        setLabel("No controller found", Color(0.812f, 0.341f, 0.235f, 1f)) // red
        fadeInAndOut()
    }

...
class Beard(player: Player) : BaseActor(0f, 0f, player.stage) {
    ...
    private fun loadAnimation(number: Int) {
        ...
        for (i in 1..20)
            animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/idle1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/idle2"))
        idleAnimation = Animation(.1f, animationImages, Animation.PlayMode.LOOP_PINGPONG)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runWES1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runWES2"))
        runWESAnimation = Animation(.1f, animationImages, Animation.PlayMode.LOOP_PINGPONG)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runWEN1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runWEN2"))
        runWENAnimation = Animation(.1f, animationImages, Animation.PlayMode.LOOP_PINGPONG)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runN1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runN2"))
        runNAnimation = Animation(.1f, animationImages, Animation.PlayMode.LOOP_PINGPONG)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runS1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/runS2"))
        runSAnimation = Animation(.1f, animationImages, Animation.PlayMode.LOOP_PINGPONG)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/death1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/death2"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/death3"))
        deathAnimation = Animation(.2f, animationImages)
        animationImages.clear()

        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/smile1"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/smile2"))
        animationImages.add(BaseGame.textureAtlas!!.findRegion("player/beard/beard $number/smile3"))
